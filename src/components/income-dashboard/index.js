    ...
    <Dialog>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Edit your existing income category
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <EditCategoryForm
    ...
    <Dialog>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new subcategory for your income category
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
    ...
    >
      ...
      <CardContent>
        <div className="flex flex-row gap-2 items-center">
          ...
          <ProgressCategory
            value={category.currentIncome / category.proratedGoal}
          />
...
const DatePickers = ({ startDate, endDate }) => {
  ...
  const setStartDate = (date) => {
    if (date <= endDateDate) {
      ...
      setTimeout(() => {
        router.push(
          `/app/income?startDate=${format(date, 'yyyy-MM-dd')}&endDate=${format(
            endDateDate,
            'yyyy-MM-dd'
          )}`
        );
  ...
  const setEndDate = (date) => {
    if (date >= startDateDate) {
      ...
      setTimeout(() => {
        router.push(
          `/app/income?startDate=${format(startDateDate, 'yyyy-MM-dd')}&endDate=${format(
            date,
            'yyyy-MM-dd'
          )}`
        );
