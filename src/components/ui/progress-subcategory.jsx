...
const ProgressSubcategory = React.forwardRef(
  (
    ...
    return (
      <div className="relative w-full">
        ...
        <div
          className="absolute top-[11px] left-0 text-md font-bold text-primary transition-opacity duration-200"
          style={{
...
ProgressSubcategory.displayName = ProgressPrimitive.Root.displayName;

export { ProgressSubcategory };
